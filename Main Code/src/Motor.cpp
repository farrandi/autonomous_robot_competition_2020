...
void Motor::drive_cw_slow(){
  this->stop();
  delay(50);
  pwm_start(MOTOR_LF, FREQUENCY, MAX_MOTOR* TURN_SPEED, RESOLUTION_16B_COMPARE_FORMAT);
}
...
void Motor::drive_ccw_slow(){
  this->stop();
  delay(50);
  pwm_start(MOTOR_RF, FREQUENCY, MAX_MOTOR* TURN_SPEED * MOTOR_RATIO, RESOLUTION_16B_COMPARE_FORMAT);
}
